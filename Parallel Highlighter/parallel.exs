defmodule Syntaxhighlighter do
  ...
  def main() do
    ...
    #TAsk.async hace el thread y lo echa a correr
    id1= Task.async(fn -> highlight("example.py", "example.html") end)
    id2= Task.async(fn -> highlight("example2.py", "thread2.html") end)
    id3= Task.async(fn -> highlight("example3.py", "thread3.html") end)
    Task.await(id1)
    Task.await(id2)
    Task.await(id3)
