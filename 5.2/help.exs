...
# IO.inspect(Hw.Primes.total_sum(start, finish, cores)
# IO.inspect(Hw.Primes.total_sum(1, 10, 1))    # Output: 17 (sum of prime numbers from 1 to 10)
# IO.inspect(Hw.Primes.total_sum(1, 100, 2))   # Output: 1060 (sum of prime numbers from 1 to 100)
# IO.inspect(Hw.Primes.total_sum(1, 1000, 4))  # Output: 76127 (sum of prime numbers from 1 to 1000)
# IO.inspect(Hw.Primes.total_sum(1, 10000, 8)) # Output: 5736396 (sum of prime numbers from 1 to 10000)
# IO.inspect(Hw.Primes.total_sum(100, 500, 1)) # Output: 20476 (sum of prime numbers from 100 to 500)

# IO.inspect(Hw.Primes.total_sum[{100, 200}, {201, 300}, {301, 400}, {401, 500}])
